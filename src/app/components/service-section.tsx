  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="w-24 h-1 bg-black/30 mx-auto rounded-full mb-4"></div>
...
function ServiceCard({ icon, title, description }: ServiceCardProps) {
  return (
    <article className="bg-black rounded-lg p-8 text-white shadow-xl hover:shadow-2xl group relative overflow-hidden transition-transform duration-300 hover:scale-105">
      {/* Décor animé en haut à droite */}
